...
{
    const char *base = "assets/Biker/";

    struct { AnimID id; const char *file; float spf; bool loop; } defs[] = {
        { ANIM_IDLE,        "Biker_idle.png",        0.12f, true  },
        { ANIM_WALK,        "Biker_walk.png",        0.10f, true  },
        { ANIM_RUN,         "Biker_run.png",         0.08f, true  },
        { ANIM_DASH,        "Biker_dash.png",        0.07f, false },
        { ANIM_JUMP,        "Biker_jump.png",        0.12f, false },
        { ANIM_DOUBLEJUMP,  "Biker_doublejump.png",  0.10f, false },
        { ANIM_SITDOWN,     "Biker_sitdown.png",     0.12f, false },
        { ANIM_HAPPY,       "Biker_happy.png",       0.12f, false },
        { ANIM_ANGRY,       "Biker_angry.png",       0.10f, false },
        { ANIM_HURT,        "Biker_hurt.png",        0.10f, false },
        { ANIM_DEATH,       "Biker_death.png",       0.12f, false },
        { ANIM_PUNCH,       "Biker_punch.png",       0.08f, false },
        { ANIM_WALK_ATTACK, "Biker_walk_attack.png", 0.08f, false },
        { ANIM_RUN_ATTACK,  "Biker_run_attack.png",  0.07f, false },
        { ANIM_ATTACK1,     "Biker_attack1.png",     0.09f, false },
        { ANIM_ATTACK2,     "Biker_attack2.png",     0.09f, false },
        { ANIM_ATTACK3,     "Biker_attack3.png",     0.09f, false },
    };
